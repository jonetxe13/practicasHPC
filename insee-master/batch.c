...
/** Previous Consumed Load (during convergency checking phase). */
double prev_cons_load;

/** Previous Average Latency (during convergency checking phase). */
double prev_latency;

/** Number of convergences occurred in a row (during convergency checking phase).
...
* average delay, delay standard deviation, maximum delay,
* average injection delay, injection delay standard deviation,
* maximum injection delay.
*
...
*
* Calculates the % of difference between current & previous load & latency.
*
...
void convergency(void){
	...
	// Adjust for equal sample acquiring
...
*
* The simulation is split in three phases:
* Warm-up, Convergency checking & Stationary state.
*
* @see warm_up()
* @see convergency()
* @see stationary()
