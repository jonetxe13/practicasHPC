...
*@file dimemas.h
*
*@brief	This file defines the dimemas trace format given by the UPC. It may have changed over time.
...
*/
enum event_type{
	POINT2POINT=50000001,
	COLLECTIVES=50000002,
	OTHERS=     50000003
} event_type;
